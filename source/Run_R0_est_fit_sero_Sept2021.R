...
countries_of_interest_path <- "R0_model/data/vimc_countries_of_interest_202110gavi_v1.csv"
...
#source("R0_model/source/get_ageadj_R0.R")

country_year <- read.csv(file=file.path("R0_model","data", analysis_version_data, "r_ratio_1980.csv"))
tmp_data <- sero_data %>% 
...
fileName_R0_est <- "R0_model/source/R0_est_contactadj_betabinom_withgq.stan"
fileName_R0_est <- "R0_model/source/R0_est_contactadj_betabinom_withgq_fast.stan"

ret <- stanc(fileName_R0_est) # Check Stan file
ret_sm <- stan_model(stanc_ret = stanc(fileName_R0_est)) # Compile Stan code
save(fileName_R0_est, ret, ret_sm, file="R0_model/source/R0_est_contactadj_betabinom_withgq_fast_compiled.RData")
#load(file="R0_model/source/R0_est_contactadj_betabinom_withgq_compiled.RData")
load(file="R0_model/source/R0_est_contactadj_betabinom_withgq_fast_compiled.RData")
...
inits <- list(inits_, inits_, inits_, inits_)
fit_R0 <- sampling(ret_sm, warmup=1000, iter=2000, seed=12345, data=sero_data_stan, 
...
# Save STAN results
save(ret, ret_sm, fit_R0, sero_data_stan, sero_data, file=file.path(analysis_version_repo, "R0_full_2000iters.RData"))
load(file=file.path(analysis_version_repo, "R0_full_2000iters.RData")) # Loads ret_sm, fit_R0_test, sero_data_stan_list
